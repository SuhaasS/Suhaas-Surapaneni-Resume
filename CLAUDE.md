...
- **One line per bullet.** A bullet point must never wrap to a second line. Each bullet may be at most 97 characters (visible output only, LaTeX commands don't count).
